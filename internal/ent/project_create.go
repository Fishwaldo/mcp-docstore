...
func (_c *ProjectCreate) SetNillableVisibility(v *project.Visibility) *ProjectCreate {
	if v != nil {
		_c.SetVisibility(*v)
	}
	return _c
...
func (_c *ProjectCreate) SetArchived(v bool) *ProjectCreate {
	_c.mutation.SetArchived(v)
	return _c
}

// SetNillableArchived sets the "archived" field if the given value is not nil.
func (_c *ProjectCreate) SetNillableArchived(v *bool) *ProjectCreate {
	if v != nil {
		_c.SetArchived(*v)
	}
	return _c
...
func (_c *ProjectCreate) SetTenantID(id uuid.UUID) *ProjectCreate {
	_c.mutation.SetTenantID(id)
	return _c
}

// SetTenant sets the "tenant" edge to the Tenant entity.
func (_c *ProjectCreate) SetTenant(v *Tenant) *ProjectCreate {
...
func (_c *ProjectCreate) AddGroupShareIDs(ids ...uuid.UUID) *ProjectCreate {
	_c.mutation.AddGroupShareIDs(ids...)
	return _c
}

// AddGroupShares adds the "group_shares" edges to the ProjectGroupShare entity.
func (_c *ProjectCreate) AddGroupShares(v ...*ProjectGroupShare) *ProjectCreate {
	ids := make([]uuid.UUID, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
	return _c.AddGroupShareIDs(ids...)
}
...
func (_c *ProjectCreate) check() error {
	...
	if _, ok := _c.mutation.Archived(); !ok {
		return &ValidationError{Name: "archived", err: errors.New(`ent: missing required field "Project.archived"`)}
	}
	if _, ok := _c.mutation.UpdatedAt(); !ok {
...
func (_c *ProjectCreate) createSpec() (*Project, *sqlgraph.CreateSpec) {
	...
	if nodes := _c.mutation.GroupSharesIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
