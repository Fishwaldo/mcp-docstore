...
func (_q *OAuthRefreshTokenQuery) FirstID(ctx context.Context) (id uuid.UUID, err error) {
	var ids []uuid.UUID
...
func (_q *OAuthRefreshTokenQuery) FirstIDX(ctx context.Context) uuid.UUID {
...
func (_q *OAuthRefreshTokenQuery) OnlyID(ctx context.Context) (id uuid.UUID, err error) {
	var ids []uuid.UUID
...
func (_q *OAuthRefreshTokenQuery) OnlyIDX(ctx context.Context) uuid.UUID {
...
func (_q *OAuthRefreshTokenQuery) IDs(ctx context.Context) (ids []uuid.UUID, err error) {
...
func (_q *OAuthRefreshTokenQuery) IDsX(ctx context.Context) []uuid.UUID {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (_q *OAuthRefreshTokenQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(oauthrefreshtoken.Table, oauthrefreshtoken.Columns, sqlgraph.NewFieldSpec(oauthrefreshtoken.FieldID, field.TypeUUID))
	_spec.From = _q.sql
